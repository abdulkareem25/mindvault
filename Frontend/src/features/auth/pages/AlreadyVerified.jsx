      ...
      <div className="w-full max-w-md">
        <div className="card">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-20 h-20 bg-vault-focus/20 rounded-full flex items-center justify-center border border-vault-focus/40">
              <svg
                className="w-10 h-10 text-vault-focus"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
